 ...
 * leader (usually a process that provides a api, exclusively) would
 ...
 * as a leader for this api. A read of all leader offers is then performed.
 ...
 * doesn't actually provide the api in question. It is up to the user to
 ...
 * <li>It is possible for ZK timeouts and retries to play a role in api
...
public class LeaderElectionSupport implements Watcher {
  ...
  /**
   * <p>
   * Gets the ZooKeeper root node to use for this api.
   * </p>
   * <p>
   * For instance, a root node of {@code /mycompany/myservice} would be the
   * parent of all leader offers for this api. Obviously all processes that
  ...
  /**
   * <p>
   * Sets the ZooKeeper root node to use for this api.
   * </p>
   * <p>
   * For instance, a root node of {@code /mycompany/myservice} would be the
   * parent of all leader offers for this api. Obviously all processes that
  ...
  /**
   * The internal state of the election support api.
   */
