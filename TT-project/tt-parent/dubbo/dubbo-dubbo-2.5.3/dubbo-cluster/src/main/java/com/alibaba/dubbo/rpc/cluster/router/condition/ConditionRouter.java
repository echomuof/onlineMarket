    ...
    public <T> List<Invoker<T>> route(List<Invoker<T>> invokers, URL url, Invocation invocation)
        ...
        try {
            ...
            if (thenCondition == null) {
            	logger.warn("The current consumer in the api blacklist. consumer: " + NetUtils.getLocalHost() + ", api: " + url.getServiceKey());
                return result;
            }
            ...
            if (result.size() > 0) {
            	...
            	logger.warn("The route result is empty and force execute. consumer: " + NetUtils.getLocalHost() + ", api: " + url.getServiceKey() + ", router: " + url.getParameterAndDecoded(Constants.RULE_KEY));
            	return result;
            }
        } catch (Throwable t) {
