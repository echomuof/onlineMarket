...
public class Constants {
    ...
    public static final String  SERVICE_FILTER_KEY                 = "api.filter";
     ...
     * callback inst id
     */
    public static final String  CALLBACK_SERVICE_KEY               = "callback.api.instid";
    ...
    public static final String  CALLBACK_SERVICE_PROXY_KEY         = "callback.api.proxy";
    ...
    @Deprecated
    public static final String  SHUTDOWN_WAIT_SECONDS_KEY          = "dubbo.api.shutdown.wait.seconds";

    public static final String  SHUTDOWN_WAIT_KEY                  = "dubbo.api.shutdown.wait";
