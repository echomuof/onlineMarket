...
{
	final String ServiceName = "com.alibaba.dubbo.rpc.api.GenericService";
	...
	public void testMap2Parameters() throws Exception
	{
		...
		map.put("name", "com.alibaba.dubbo.rpc.api.GenericService");
	...
	{
		String qs = "name=com.alibaba.dubbo.rpc.api.GenericService&version=1.0.15&lb=lcr";
