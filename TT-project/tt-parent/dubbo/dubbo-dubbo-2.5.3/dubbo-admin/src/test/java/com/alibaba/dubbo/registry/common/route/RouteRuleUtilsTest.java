...
public class RouteRuleUtilsTest {
    ...
    public void test_filterServiceByRule()throws Exception {
         ...
         route.setMatchRule("api=com.alibaba.*,AuthService&api!=com.alibaba.DomainService,com.alibaba.ViewCacheService&consumer.host!=127.0.0.1,15.11.57.6&consumer.version = 2.0.0&consumer.version != 1.0.0");
    ...
    public void test_filterServiceByRule2()throws Exception {
     ...
     Route route = new Route();
     route.setMatchRule("api=com.alibaba.PC2Service&api!=com.alibaba.DomainService,com.alibaba.ViewCacheService&consumer.host!=127.0.0.1,15.11.57.6&consumer.version = 2.0.0&consumer.version != 1.0.0");
     route.setFilterRule("provider.application=morgan,pc2&provider.host=10.16.26.51&provider.port=1020");
     RouteRule rr = RouteRule.parse(route);
     Collection<String> changedService = RouteRuleUtils.filterServiceByRule(services, rr);
