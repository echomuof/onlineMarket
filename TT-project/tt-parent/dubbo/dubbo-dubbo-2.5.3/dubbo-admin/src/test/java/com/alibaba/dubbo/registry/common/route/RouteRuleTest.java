...
public class RouteRuleTest {
    ...
    public void testParse_EmptyThen() {
        String expr = "api=com.alibaba.MemberService,AuthService&consumer.host=127.0.0.1&consumer.version != 1.0.0";
        try{
    ...
    public void testParse_NoKeyName() {
        try{
            RouteRule.parse("api=com.alibaba.MemberService,AuthService&consumer.host=127.0.0.1&!=valueOnnnnnly",
    ...
    public void testParse_MatchRight() throws Exception {
        ...
        assertEquals(RouteRule.createFromCondition(whenParams, thenParams),
                RouteRule.parse("api=com.alibaba.MemberService,AuthService&consumer.host=127.0.0.1,17.58.25.62&consumer.version = 1.0.0,1.0.6",
    ...
    public void testParse_MisMatchRight() throws Exception {
        ...
        assertEquals(RouteRule.createFromCondition(whenParams, thenParams),
                RouteRule.parse("api!=com.alibaba.MemberService,AuthService&consumer.host!=127.0.0.1&consumer.version != 1.0.0,1.0.6",
                		"provider.application!=morgan,pc2&provider.host!=10.16.26.51&provider.port!=1020"));
    }
    ...
    public void testParse_Simple() throws Exception {
        ...
        assertEquals(RouteRule.createFromCondition(whenParams, thenParams),
                RouteRule.parse("api=com.alibaba.morgan.*&api!=com.alibaba.morgan.MemberService", "provider.host=10.16.26.51"));
    }
    ...
    public void testParse_AllRight() throws Exception {
        ...
        assertEquals(RouteRule.createFromCondition(whenParams, thenParams),
                RouteRule.parse("api=com.alibaba.MemberService,AuthService&api!=com.alibaba.DomainService,com.alibaba.ViewCacheService" +
