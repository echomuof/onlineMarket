...
public class MemcachedProtocol extends AbstractProtocol {
    ...
    public <T> Exporter<T> export(final Invoker<T> invoker) throws RpcException {
        throw new UnsupportedOperationException("Unsupported export memcached api. url: " + invoker.getUrl());
    }
    ...
    public <T> Invoker<T> refer(final Class<T> type, final URL url) throws RpcException {
        try {
                ...
                protected Result doInvoke(Invocation invocation) throws Throwable {
                    try {
                        if (get.equals(invocation.getMethodName())) {
                            ...
                            throw new UnsupportedOperationException("Unsupported method " + invocation.getMethodName() + " in memcached api.");
                        }
                    } catch (Throwable t) {
                        RpcException re = new RpcException("Failed to invoke memecached api method. interface: " + type.getName() + ", method: " + invocation.getMethodName() + ", url: " + url + ", cause: " + t.getMessage(), t);
            ...
            throw new RpcException("Failed to refer memecached api. interface: " + type.getName() + ", url: " + url + ", cause: " + t.getMessage(), t);
        }
    }
