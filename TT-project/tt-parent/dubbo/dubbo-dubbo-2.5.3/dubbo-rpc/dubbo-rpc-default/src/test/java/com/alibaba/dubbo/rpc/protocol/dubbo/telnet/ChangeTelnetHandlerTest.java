...
public class ChangeTelnetHandlerTest {
    ...
    public void setUp() {
        ...
        EasyMock.expect(mockChannel.getAttribute("telnet.api")).andReturn("com.alibaba.dubbo.rpc.protocol.dubbo.support.DemoService").anyTimes();
        mockChannel.setAttribute("telnet.api", "DemoService");
        EasyMock.expectLastCall().anyTimes();
        mockChannel.setAttribute("telnet.api", "com.alibaba.dubbo.rpc.protocol.dubbo.support.DemoService");
        EasyMock.expectLastCall().anyTimes();
        mockChannel.setAttribute("telnet.api", "demo");
        EasyMock.expectLastCall().anyTimes();
        mockChannel.removeAttribute("telnet.api");
        EasyMock.expectLastCall().anyTimes();
    ...
    public void testChangeSimpleName() throws RemotingException {
        ...
        assertEquals("Used the DemoService as default.\r\nYou can cancel default api by command: cd /", result);
    }
