...
public class RmiProtocolTest
{
    ...
    */
	...
	{
		DemoService api = new DemoServiceImpl();
		RpcUtils.export("demo://127.0.0.1:9030/com.alibaba.dubbo.rpc.TestService",DemoService.class,api);
		RpcUtils.export("dubbo://127.0.0.1:9031/TestService",DemoService.class,api);
		RpcUtils.export("rmi://127.0.0.1:9032/com.alibaba.dubbo.rpc.TestService",DemoService.class,api);
		RpcUtils.export("rmi://127.0.0.1:9033/com.alibaba.dubbo.rpc.TestService",DemoService.class,api);

		api = RpcUtils.createProxy(DemoService.class,
				new String[]{
		...
		assertEquals(api.getSize(null), -1);
		assertEquals(api.getSize(new String[]{"","",""}), 3);
	...
	{
		DemoService api = new DemoServiceImpl();
		protocol.export(proxy.createInvoker("dubbo://127.0.0.1:9040/TestService", DemoService.class, api);
		protocol.export(proxy.createInvoker("dubbo://127.0.0.1:9041/TestService", DemoService.class, api);
		protocol.export(proxy.createInvoker("rmi://127.0.0.1:9042/com.alibaba.dubbo.rpc.TestService", DemoService.class, api);
		protocol.export(proxy.createInvoker("rmi://127.0.0.1:9043/com.alibaba.dubbo.rpc.TestService", DemoService.class, api);
		...
		api = proxy.createProxy(protocol.refer(DemoService.class, group);
		api.echo("test");
