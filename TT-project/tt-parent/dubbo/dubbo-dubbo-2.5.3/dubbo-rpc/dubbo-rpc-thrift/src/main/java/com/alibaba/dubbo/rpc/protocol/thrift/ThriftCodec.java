...
//                protocol.readI32(); // skip the first message length
        ...
        if ( message.type == TMessageType.CALL ) {
            ...
            if ( StringUtils.isEmpty( resultClassName ) ) {
                throw new IllegalArgumentException(
                        new StringBuilder( 32 )
                                .append( "Could not infer api result class name from api name " )
                                .append( serviceName )
                                .append( ", the api name you specified may not generated by thrift idl compiler" )
                                .toString() );
            }
    ...
    private void encodeRequest( Channel channel, ChannelBuffer buffer, Request request )
        ...
        if ( StringUtils.isEmpty( serviceName ) ) {
            throw new IllegalArgumentException(
                    new StringBuilder( 32 )
                            .append( "Could not find api name in attachment with key " )
