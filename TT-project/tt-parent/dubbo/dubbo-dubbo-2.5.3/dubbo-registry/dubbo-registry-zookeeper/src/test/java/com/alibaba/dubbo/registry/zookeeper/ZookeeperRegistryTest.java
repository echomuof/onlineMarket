...
public class ZookeeperRegistryTest {
    ...
    public void setUp() throws Exception {
        //registry.register(api, serviceUrl);
    }
    ...
    public void testRegister() {
        ...
        // clear first
        registered = registry.getRegistered(api);
    ...
    public void testSubscribe() {
        ...
        registry.subscribe(api, new URL("dubbo", NetUtils.getLocalHost(), 0, StringUtils.parseQueryString(subscribearg)), new NotifyListener() {

            public void notify(List<URL> urls) {
                // FIXME assertEquals(ZookeeperRegistry.this.api, api);
                args.set(urls.get(0).getParameters());
            }
        });
        assertEquals(serviceUrl.toParameterString(), StringUtils.toQueryString(args.get()));
        Map<String, String> arg = registry.getSubscribed(api);
