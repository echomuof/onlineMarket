                                ...
                                if (isPrimitive(type)) {
                                    ...
                                    if ("ref".equals(property) && parserContext.getRegistry().containsBeanDefinition(value)) {
                                        ...
                                        if (! refBean.isSingleton()) {
                                            throw new IllegalStateException("The exported api ref " + value + " must be singleton! Please set the " + value + " bean scope to singleton, eg: <bean id=\"" + value+ "\" scope=\"singleton\" ...>");
                                        }
                                    }
