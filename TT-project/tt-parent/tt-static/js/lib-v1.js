...
!function() {
    ...
    var a = $("#api-2013 a[href='http://en.360buy.com/']");
...
!function() {
    pageConfig.FN_ImgError(document), $("img[data-lazyload]").Jlazyload({type: "image",placeholderClass: "err-product"}), category.FN_Init(), document.getElementById("shortcut") ? $("#shortcut .menu").Jdropdown({delay: 50}) : ($("#biz-api").Jdropdown({delay: 50}, function() {
